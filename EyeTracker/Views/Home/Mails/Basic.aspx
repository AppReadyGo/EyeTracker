...
Inherits="System.Web.Mvc.ViewPage<EyeTracker.Model.Pages.Home.Mails.BasicMailContentModel>" %>
...
<div marginwidth="0" marginheight="0" style="margin: 0; padding: 0; background-color: #ededed; width: 100%!important">
    <center>
        ...
        <p style="color:#878787;font-family:Arial;font-size:11px;line-height:157%;padding:15px 0 5px 0;margin:0">
            ...
            <!-- Annoyed? <a href="{unsubscribe}" style="color:#878787;font-weight:normal;text-decoration:underline" target="_blank">Unsubscribe</a> at any time.-->
        </p>
        <%} %>
                                                ...
                                                <tbody><tr>
                                                    <td colspan="2" valign="middle" style="border-collapse:collapse;background-color:#ffffff;border:0">
                                                        <div style="color:#707070;font-family:Arial;font-size:11px;line-height:150%;text-align:left">
                                                            ...
                                                            <p>Join our fantastic community: <a href="<%:Model.Twitter %>" style="color:#707070;font-weight:normal;text-decoration:underline" target="_blank">follow us on Twitter</a> and <a href="<%:Model.Facebook %>" style="color:#707070;font-weight:normal;text-decoration:underline" target="_blank">join us on Facebook</a></p>

Contact us at: <%:Model.Email %>.</p>
        <%if (Model.IsMail)
          { %>
<p><!--<a href="{unsubscribe}" style="color:#707070;font-weight:normal;text-decoration:underline" target="_blank">unsubscribe</a> | --><a href="<%:Model.ThisEmailUrl %>" style="color:#707070;font-weight:normal;text-decoration:underline" target="_blank">view it in your browser</a></p>
<%} %>
                                                        </div>
                                                    </td>
                                                </tr>
    ...
    <img src="http://smashingmagazine.us1.list-manage.com/track/open.php?u=16b832d9ad4b28edf261f34df&amp;id=692a8278b8&amp;e=337c65a65d" height="1" width="1">
</div>
</asp:Content>
