...
{
    public class HeatMapDataQuery : IQuery<IEnumerable<HeatMapDataResult>>
    {
        ...
        public HeatMapDataQuery(long appId, string path, int clientWidth, int clientHeight, DateTime fromDate, DateTime toDate)
        {
