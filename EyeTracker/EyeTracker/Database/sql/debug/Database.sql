...
CREATE DATABASE [$(DatabaseName)]
    ON 
    PRIMARY(NAME = [EyeTracker_1], FILENAME = '$(DefaultDataPath)$(DatabaseName).mdf', FILEGROWTH = 1024 KB)
    LOG ON (NAME = [EyeTracker_1_log], FILENAME = '$(DefaultLogPath)$(DatabaseName)_log.ldf', MAXSIZE = 2097152 MB, FILEGROWTH = 10 %) COLLATE SQL_Latin1_General_CP1_CI_AS
GO
...
GO
PRINT N'Creating [dbo].[AccountProfiler]...';
...
GO
PRINT N'Creating [dbo].[ClickEvent]...';
...
GO
PRINT N'Creating [dbo].[OperationSystem]...';
...
GO
PRINT N'Creating [dbo].[ViewPartEvent]...';
...
GO
PRINT N'Creating [dbo].[VisitEvent]...';
...
GO
PRINT N'Creating FK6AF3367D1CF53E7...';
...
GO
PRINT N'Creating FK49650677F9D3FC1C...';


GO
ALTER TABLE [dbo].[Click] WITH NOCHECK
...
GO
PRINT N'Creating FK5DAF59DA6C1A54A6...';


GO
ALTER TABLE [dbo].[PageView] WITH NOCHECK
...
GO
PRINT N'Creating FK5DAF59DA9DB60BE...';
...
GO
PRINT N'Creating FK5DAF59DAAF84173A...';
...
GO
PRINT N'Creating FK5DAF59DAC633B88...';
...
GO
PRINT N'Creating FK5DAF59DAD1970229...';
...
GO
PRINT N'Creating FKBEF9D818C633B88...';


GO
ALTER TABLE [dbo].[Screen] WITH NOCHECK
...
GO
PRINT N'Creating FK4AD899C9F9D3FC1C...';


GO
ALTER TABLE [dbo].[ViewPart] WITH NOCHECK
...
GO
PRINT N'Creating [Utils].[CreateBinaryInserts]...';


GO
CREATE PROCEDURE [Utils].[CreateBinaryInserts]
...
GO
ALTER TABLE [dbo].[Application] WITH CHECK CHECK CONSTRAINT [FK6AF3367D1CF53E7];

ALTER TABLE [dbo].[Click] WITH CHECK CHECK CONSTRAINT [FK49650677F9D3FC1C];

ALTER TABLE [dbo].[PageView] WITH CHECK CHECK CONSTRAINT [FK5DAF59DA6C1A54A6];

ALTER TABLE [dbo].[PageView] WITH CHECK CHECK CONSTRAINT [FK5DAF59DA9DB60BE];

ALTER TABLE [dbo].[PageView] WITH CHECK CHECK CONSTRAINT [FK5DAF59DAAF84173A];

ALTER TABLE [dbo].[PageView] WITH CHECK CHECK CONSTRAINT [FK5DAF59DAC633B88];

ALTER TABLE [dbo].[PageView] WITH CHECK CHECK CONSTRAINT [FK5DAF59DAD1970229];

ALTER TABLE [dbo].[Screen] WITH CHECK CHECK CONSTRAINT [FKBEF9D818C633B88];

ALTER TABLE [dbo].[ViewPart] WITH CHECK CHECK CONSTRAINT [FK4AD899C9F9D3FC1C];
