...
<div class="wrap">
	...
	<div class="t-nav">
		...
		<div class="a-l search-box">
			...
			<input type="button" name="" id="search-submit" class="button" value="Search" onclick="javascript: document.location.href = '/Admin/Staff?cp=1&srch=' + escape($('#user-search-input').val());" />
		</div>
