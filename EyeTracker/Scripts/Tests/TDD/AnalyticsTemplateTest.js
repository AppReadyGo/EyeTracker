...
test('WcfService', function () {
    var body = '{"n1":1,"n2":2}';
    $.ajax({
        type: 'POST',
        url: 'http://localhost:37369/AnalyticsService.svc/Package',
...
//    //data = 'json=' + data;
//    xmlhttp.open("POST", 'http://localhost:37369/AnalyticsService.svc/Package', true);
//    xmlhttp.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded'); //'application/x-www-form-urlencoded');application/json
